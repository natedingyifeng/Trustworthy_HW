...
(ite (< x 1) (* x x) (* (* x x) x))      ; absolute value function
)
...
(ite (> l 1) (* (* l l) l) (ite (> l 0) (* l l) (ite (> u 0) 0 (* u u))))
)

(define-fun Tf_upper ((l Real) (u Real)) Real
(ite (> u 1) (ite (> l 0) (* (* u u) u) (ite (> (* l l) (* (* u u) u)) (* l l) (* (* u u) u))) (ite (> l 0) (* u u) (ite (> (* l l) (* u u)) (* l l) (* u u))))
)
